...
Every session, this file gets loaded into the context window — consuming tokens alongside your actual conversation. The official guidance is to **target under 200 lines**. Longer files consume more context _and_ reduce adherence.
...
_Reference:_ [_Claude Code memory documentation_](https://code.claude.com/docs/en/memory)
